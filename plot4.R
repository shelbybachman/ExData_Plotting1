...
png(filename = path('plot4.png'), width = 480, height = 480)

# adjust graphical parameters to allow for 2x2 subplots
defaults = par() # save default graphical parameters
par(mfrow = c(2,2)) # adjust parameters

# create subplot 1 (same as plot 2: global active power across time)
plot(data$Global_active_power~data$dateTime, type = 'l',
     xlab = '',
     ylab = 'Global Active Power (kilowatts)')

# create subplot 2 (voltage across time)
plot(data$Voltage~data$dateTime, col = 'black', type = 'l',
     xlab = 'datetime', ylab = 'Voltage')

# create subplot 3 (same as plot 3: sub metering across time)
...
# create subplot 4 (global reactive power across time)
plot(data$Global_reactive_power~data$dateTime, col = 'black', type = 'l', 
